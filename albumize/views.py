...
class LandingPageView(TemplateView):
    template_name = 'albumize/landing.html'
...
class HomeView(LoginRequiredMixin, UserPassesTestMixin, ListView):
    model = Album
    template_name = 'albumize/home.html'
...
class AlbumListView(LoginRequiredMixin, UserPassesTestMixin, ListView):
    model = Album
    template_name = 'albumize/album_list.html'
    context_object_name = 'albums'
    ordering = ['-id']
...
class AlbumDetailView(LoginRequiredMixin, UserPassesTestMixin, DetailView):
    model = Album
    template_name = 'albumize/album_photos_view.html'
...
class AlbumCreateView(LoginRequiredMixin, CreateView):
    model = Album
    template_name = 'albumize/create_album.html'
...
class AlbumUpdateView(LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    model = Album
    template_name = 'albumize/edit_album.html'
    fields = ['title', 'release_date', 'cover_image']
